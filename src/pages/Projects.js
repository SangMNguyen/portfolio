...
const content = [
    {
        ...
        and it is a complete work-in-progress which had to be temporarily shelved due to [REDACTED]`
    }, {
        image: Image3,
        title: 'Discord Bot',
        ...
        Capstone program. I was apart of this project along with 4 other students and my
        role was 1 of the 2 Front-End Developers. My reponsibilities included implementing
        wireframes that our UX Designer came up with, translating the wireframes to a high-
        fidelity design, discussing a logical flow of the application, and connecting the
...
export default class Projects extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            links: [
                'https://github.com/SangMNguyen/Pong', 
                'https://github.com/sangmattxavier/Project-GG',
                'https://github.com/SangMNguyen/DiscordBot'
            ],
        }
    }
